...
def preprocess_features(housing_dataframe):
    ...
    Args:
        california_housing_dataframe: A Pandas DataFrame expected
        to contain data from the California housing data set.
    Returns:
...
def preprocess_targets(housing_dataframe):
    ...
    from California housing data set.
    ...
    output_targets["median_house_value_is_high"] = (
        housing_dataframe["median_house_value"] > 265000).astype(float)
...
def train_linear_regressor_model(
  ...
  """
    ...
    for period in range(0, periods):
        ...
        print("  period {0:2d} : {1:0.2f}".format(
...
def train_linear_classifier_model(
    ...
    In addition to training, this function also prints
    training progress information as well as a plot
    of the training and validation loss over time.
    ...
    for period in range(0, periods):
        ...
        # Occasionally print the current loss.
        print("  period {0:2d} : {1:0.2f}".format(period, training_log_loss))
    ...
    plt.draw()
    plt.pause(10)
    print("AUC on the validation set: {0:.2f}".format(evaluation_metrics['auc']))
